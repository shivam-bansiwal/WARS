<%-- 
    Document   : tablestu
    Created on : 18 Jul, 2018, 10:43:32 AM
    Author     : Shivam
--%>
...
<html>
    ...
    <br><br><br><br>
         <%
             ...
             String bn=(String) session.getAttribute("stuename");
             
            try {
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                Connection cn = DriverManager.getConnection("jdbc:derby://localhost:1527/logindatabase");
                PreparedStatement st = cn.prepareStatement("select * from signup where  ucase(name)=ucase(?)");
