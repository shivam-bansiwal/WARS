<%-- 
    Document   : applyfortraining
    Created on : 1 Jul, 2018, 5:23:56 PM
    Author     : Shivam
--%>
...
<html>
    ...
    <div class="wrap">
	<form action="applytraining.jsp" method="post">
	<h2>APTRON'S TRAINING FORM </h2>
	<input type="text" name="yourname" placeholder="Your name">
	<input type="text" name="yourfathername" placeholder="Your father name">
	<input type="email" name="email" placeholder="Your Email"> 
     	<input type="number" name="mnumber" placeholder="Your number">
	<input type="address" name="youraddress" placeholder="Your address">
...
<input type='date'>
    <select name="courses">
        ...
        <option>Linux</option>
        <option>Network Training</option>
