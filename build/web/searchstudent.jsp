<%-- 
    ...
    Created on : 17 Jul, 2018, 3:02:09 PM
    Author     : Shivam
--%>
...
<br><br><br><br>
        ...
        <table bgcolor="lightyellow" align="center" border="1" >
            ...
            <tr>
                 ...
                 <td style=" font-size:15px; "><p>&nbsp&nbsp&nbspNAME:</p></td>
                     
                    
                       <td> <input style=" font-size:25px; color:white;background-color: white;border-radius: 60px; color:black;text-align: center;" type="text" name="name"></td>
                         <td><input style="border-style: none;background-color: #00adee;width: 150px;height: 40px;border-radius: 100px;color:white;font-family: cursive; " type="submit" value="SEARCH"></td>
                   
                
                
                        <td style=" font-size:15px; "><p>&nbsp&nbsp&nbspEMAIL:</p></td>
                     
                    
                       <td> <input style=" font-size:25px; color:white;background-color: white;border-radius: 60px; color:black;text-align: center;" type="text" name="email"></td>
                         <td><input style="border-style: none;background-color: #00adee;width: 150px;height: 40px;border-radius: 100px;color:white;font-family: cursive; " type="submit" value="SEARCH"></td>
