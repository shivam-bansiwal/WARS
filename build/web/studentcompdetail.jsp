<%-- 
  Document   : studentcompdetail
  Created on : 11 Jul, 2018, 4:26:36 PM
  Author     : Shivam
--%>
...
<html>
    ...
    <body>
        ...
        <table bgcolor="lightyellow" align="center" border="1">
            ...
            %>
            <tr>
            <form action="placementapplied.jsp" method="post">
                <input type="hidden" name="cname" value=<%=rs.getString("Company_name")%> >
