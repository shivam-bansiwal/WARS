<%-- 
    Document   : searchedstudent
    Created on : 17 Jul, 2018, 3:20:45 PM
    Author     : Shivam
--%>
...
<br><br><br><br>
       <table bgcolor="lightyellow" align="center" border="1" style="border-radius:150px;
            ...
            <form action="studentsrch.jsp" method="post"> 
  ...
  <%
            String an=(String) session.getAttribute("stuemail");
          
             
            try {
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                Connection cn = DriverManager.getConnection("jdbc:derby://localhost:1527/logindatabase");
                PreparedStatement st = cn.prepareStatement("select * from signup where ucase(email)=ucase(?)");
                st.setString(1,an);
       ...
       <div style="height:300px;float:left;">
            <form action=".jsp" method="post">
                <img src="">
                <table style="float:left;margin:10px;margin-left: 130px;" width="50%">
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style=" font-size:30px; color:white;background-color:gold;border-radius: 60px;text-align: center;"><%out.print(rs.getString(5));%></td>
                    </tr>
                    <br> <tr>
                        <td style=" font-size:33px; "><p>Phone Number:</p></td>
                        
                    
                       <td style=" font-size:25px; color:white;background-color: #39dc79;border-radius: 60px;text-align: center;""><%out.print(rs.getString(3));%></td>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style=" font-size:33px; "><p>Gender:</p></td>
                    
                     
                      <td style=" font-size:25px; color:white;background-color: #39dc79;border-radius: 60px;text-align: center;"><%out.print(rs.getString(6));%></td>
                    </tr>
